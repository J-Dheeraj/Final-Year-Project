...
entry points, which OpenAnt reports reduces analysis scope by up to
97\% on real projects such as OpenSSL and WordPress -- and apply it to
a single, real, disclosed free5GC vulnerability. Beyond OpenAnt's own
