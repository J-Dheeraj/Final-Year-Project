...
Nudr\_DataRepository service-based interface -- reflected in its
source layout under \texttt{internal/sbi/} -- used by other network
functions to read and write subscriber and policy data. Because SBA
