...
real vulnerability class disclosed for this CVE family. Table~\ref{tab:handlers}
lists the four handlers by name; all share the common prefix
\texttt{HandleApplicationDataInfluenceDataSubsToNotify}, omitted below for
space.

\begin{table}[t]
\centering
\caption{Reachable UDR handlers in \texttt{api\_datarepository.go} and their patch outcome.}
\label{tab:handlers}
\small
\begin{tabular}{@{}lccc@{}}
\toprule
